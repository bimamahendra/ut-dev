...
class FormCateringReguler extends RestController {
    ...
    public function index_post(){
        ...
        if(!empty($param['idUser']) && !empty($param['idMapping'])){
            ...
            if($user != null && $mapping != null){
                ...
                $idReguler      = 'REGU_'.substr(md5(time()."reguler"), 0, 15);
                ...
                $storeReguler['ID_REGULER']         = $idReguler;
                $storeReguler['ID_TRANS']           = $idTrans;
                $this->db->insert('FORM_REGULER', $storeReguler);
                
                foreach($param['detReguler'] as $item){
                    $storeDetReguler['ID_REGULER']  = $idReguler;
                    $storeDetReguler['TGL_REGULER'] = $item['tgl'];
                    $storeDetReguler['JML_ORANG']   = $item['jmlOrang'];
                    $this->db->insert('DETAIL_REGULER', $storeDetReguler);
                }
