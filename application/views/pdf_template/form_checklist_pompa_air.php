...
<head>
    ...
    <title>FORM INSPECTION CHECK LIST POMPA AIR BERSIH</title>
...
<body>
    <div class="wrapper-page">
        ...
        <table class="w-100 border-collapse border-1 mb-min">
            <tr>
                <th class="border-1 p-min" rowspan="2">No</th>
                <th class="border-1 p-min" rowspan="2">ITEM CHECK</th>
                <th class="border-1 p-min" rowspan="2">STANDARD</th>
            ...
            <tr>
                ...
                echo '
                        ...
                        <td class="border-1 p-min text-align-center">' . ($kondAir[0] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($kondAir[2] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($kondAir[4] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($kondAir[6] == '1' ? 'V' : 'X') . '</td>
            ...
            <tr>
                ...
                echo '
                        ...
                        <td class="border-1 p-min text-align-center">' . ($pancingan[0] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($pancingan[2] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($pancingan[4] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($pancingan[6] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min">' . $ket . '</td>
                    ';
                ?>
            </tr>
            <tr>
                ...
                echo '
                        ...
                        <td class="border-1 p-min text-align-center">' . ($indikator[0] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($indikator[2] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($indikator[4] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($indikator[6] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min">' . $ket . '</td>
                    ';
                ?>
            </tr>
            <tr>
                ...
                echo '
                        ...
                        <td class="border-1 p-min text-align-center">' . ($tekanan[0] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($tekanan[2] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($tekanan[4] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($tekanan[6] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min">' . $ket . '</td>
                    ';
                ?>
            </tr>
            <tr>
                ...
                echo '
                        ...
                        <td class="border-1 p-min text-align-center">' . ($flow[0] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($flow[2] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($flow[4] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($flow[6] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min">' . $ket . '</td>
                    ';
                ?>
            </tr>
            <tr>
                ...
                echo '
                        ...
                        <td class="border-1 p-min text-align-center">' . ($supply[0] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($supply[2] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($supply[4] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($supply[6] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min">' . $ket . '</td>
                    ';
                ?>
            </tr>
            <tr>
                ...
                echo '
                        ...
                        <td class="border-1 p-min text-align-center">' . ($manual[0] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($manual[2] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($manual[4] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($manual[6] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min">' . $ket . '</td>
                    ';
                ?>
            </tr>
            <tr>
                ...
                echo '
                        ...
                        <td class="border-1 p-min text-align-center">' . ($fungsi[0] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($fungsi[2] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($fungsi[4] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min text-align-center">' . ($fungsi[6] == '1' ? 'V' : 'X') . '</td>
                        <td class="border-1 p-min">' . $ket . '</td>
                    ';
                ?>
            </tr>
        ...
        <table class="border-1 border-collapse absolute pos-right table-layout-fixed" style="width: 400px;">
            <tr>
                <th width="50%" class="border-1 p-min">Dibuat</th>
                <th width="50%" class="border-1 p-min">Diperiksa</th>
            </tr>
            <tr class="text-align-center">
