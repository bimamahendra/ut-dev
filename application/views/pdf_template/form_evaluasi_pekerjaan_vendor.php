...
<head>
	...
	<title>FORM EVALUASI PEKERJAAN VENDOR MAINTENANCE</title>
	<style>
		.watermark::before {
			position: absolute;
			top: 35%;
		...
		<table class="tg" width="100%;">
			<thead>
				<tr>
					...
					<th class="tg-k27y" colspan="2" rowspan="2">FORM EVALUASI PEKERJAAN VENDOR MAINTENANCE</th>
		...
		<table class="" width="100%" style="font-size: 12px">
			<tbody>
                ...
                <tr>
					...
					<td class="tg-5rbv" style="text-align:left; width: 30%"><b>Referenesi</b></td>
                ...
                <tr>
					...
					<td class="tg-5rbv" style="text-align:left; width: 30%"><b>Hasil Penilaian</b></td>
					<td class="tg-5r9a" style="text-align:center; width: 5%"></td>
                    <td class="tg-5r9a"></td>
				</tr>
                <tr>
                ...
                <tr>
                    <td class="tg-5r9a" style="text-align:left; width: 5%"></td>
					<td class="tg-5r9a" style="text-align:left; width: 30%; padding-left:90px;">7.1 Total nilai < 8</td>
					<td class="tg-5r9a" style="text-align:center; width: 5%">:</td>
                    <td class="tg-5r9a">Rekomendasi tidak diteruskan sebagai vendor</td>
				</tr>
                <tr>
                    <td class="tg-5r9a" style="text-align:left; width: 5%"></td>
					<td class="tg-5r9a" style="text-align:left; width: 30%; padding-left:90px;">7.2 Total nilai 8 - 11</td>
					<td class="tg-5r9a" style="text-align:center; width: 5%">:</td>
                    <td class="tg-5r9a">Rekomendasi diteruskan sebagai vendor dengan improvement</td>
				</tr>
                <tr>
                    <td class="tg-5r9a" style="text-align:left; width: 5%"></td>
					<td class="tg-5r9a" style="text-align:left; width: 30%; padding-left:90px;">7.3 Total nilai > 11</td>
					<td class="tg-5r9a" style="text-align:center; width: 5%">:</td>
                    <td class="tg-5r9a">Rekomendasi diteruskan sebagai vendor</td>
				</tr>
                <tr>
	...
	<div>
		<table class="thd">
            ...
            <tr>
				...
				<td class="thd-tha">Dievaluasi Oleh : </td>
			</tr>
