...
<body style="padding-left:0.5cm; font-family:Arial, sans-serif;">
	<div class="wrapper-page">
		...
		<br>
		<div>
			<table class="tp w-100" style="table-layout: fixed;">
				<tr>
					<th width="5%" style="text-align: center;">No</th>
					<th width="40%" style="text-align: center;">TEMUAN LAPANGAN</th>
					<th width="10%" style="text-align: center;">TANGGAL</th>
					<th width="20%" style="text-align: center;">KATEGORI TEMUAN</th>
					<th width="12.5%" style="text-align: center;">LOKASI</th>
					<th width="12.5%" style="text-align: center;">USER</th>
				</tr>
				<?php
				$no = 1;
