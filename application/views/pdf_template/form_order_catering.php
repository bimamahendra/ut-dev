...
<head>
	...
	<title>FORM ORDER CATERING</title>
	<style>
		.watermark::before {
			position: absolute;
			top: 35%;
		...
		<table class="tg" width="100%;">
			<thead>
				<tr>
					...
					<th class="tg-k27y" colspan="2" rowspan="2">FORM ORDER CATERING</th>
		...
		<table class="tg" width="100%" style="border-color: black;">
			<thead>
				<tr>
					...
					<th class="tg-5rbv" width="20%">Tanggal</th>
					<th class="tg-5rbv">Dept / Divisi</th>
                    <th class="tg-5rbv">Jumlah Order</th>
				</tr>
			</thead>
			<tbody>
				<tr>
	...
	<div>
		<table class="thd">
			<tr>
				...
				<td class="thd-tha">Diterima Oleh : </td>
			...
			<tr>
				<td class="thd-tha"><b>PIC</b></td>
				<td class="thd-tha"><b>Catering</b></td>
