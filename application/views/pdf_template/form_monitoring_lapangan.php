...
<head>
	...
	<title>FORM MONITORING LAPANGAN CATERING</title>
	<style>
		.watermark::before {
			position: absolute;
			top: 35%;
...
<body style="padding-left:0.5cm; font-family:Arial, sans-serif;">
		...
		<table class="tg" width="100%;">
			<thead>
				<tr>
					...
					<th class="tg-k27y" colspan="2" rowspan="2">FORM MONITORING LAPANGAN CATERING</th>
    ...
    <div style="text-align:center">
		<h5>FORM MONITORING LAPANGAN CATERING</h5>
	</div>
		...
		<table class="tg" width="100%" style="border-color: black;">
			<thead>
				<tr>
					...
					<th class="tg-5rbv" rowspan="2">Tgl</th>
                    <th class="tg-5rbv" rowspan="2">Jumlah Order</th>
                    <th class="tg-5rbv" rowspan="2">Actual Bawa</th>
                    <th class="tg-5rbv" rowspan="2">Actual Kupon</th>
                    <th class="tg-5rbv" colspan="3" style="width: 30%">Paraf</th>
				</tr>
                <tr>
					<td class="tg-5r9a" style="text-align:center">Catering</td>
					<td class="tg-5r9a" style="text-align:center">GS Section</td>
					<td class="tg-5r9a" style="text-align:center">Poliklinik</td>
				</tr>
			</thead>
			<tbody>
				<tr>
