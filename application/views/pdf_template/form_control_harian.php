...
<head>
	...
	<title>FORM CONTROL HARIAN</title>
	<style>
		.watermark::before {
			position: absolute;
			top: 35%;
...
<body style="padding-left:0.5cm; font-family:Arial, sans-serif;">
		...
		<table class="tg" width="100%;">
			<thead>
				<tr>
					...
					<th class="tg-k27y" colspan="2" rowspan="2">FORM CONTROL HARIAN</th>
	...
	<div>
		<table class="tg" width="100%" style="border-color: black;">
			...
			<tbody>
				<tr>
					<td class="tg-5r9a">1.</td>
					<td class="tg-5r9a">Kondisi Karyawan</td>
					<?php 
					$pemeriksaan = explode(';', $list[0]->KONDISI_CONTROL);
						echo '
							<td class="tg-5r9a">'.($pemeriksaan[0] == 1 ? 'v' : '').'</td>
							<td class="tg-5r9a">'.($pemeriksaan[0] == 2 ? 'v' : '').'</td>					
							<td class="tg-5r9a">'.($pemeriksaan[0] == 3 ? 'v' : '').'</td>
							<td class="tg-5r9a">'.($pemeriksaan[0] == 4 ? 'v' : '').'</td>
							<td class="tg-5r9a">'.$pemeriksaan[1].'</td>
						';						
					?>
				</tr>
				<tr>
					<td class="tg-5r9a">2.</td>
					<td class="tg-5r9a">Kendaraan</td>
					<?php 
				...
				<tr>
					<td class="tg-5r9a">3. </td>
					<td class="tg-5r9a">Penyajian Makanan</td>
					<?php 
				...
				<tr>
					<td class="tg-5r9a">4.</td>
					<td class="tg-5r9a">Jumlah Pesanan</td>
					<?php 
				...
				<tr>
					<td class="tg-5r9a">5.</td>
					<td class="tg-5r9a">Sample yang ditempatkan di poliklinik</td>
					<?php 
				...
				<tr>
					<td class="tg-5r9a">6.</td>
					<td class="tg-5r9a">Kebersihan Penyajian</td>
					<?php 
