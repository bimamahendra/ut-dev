		...
		<table class="tg" width="100%;">
			<thead>
				<tr>
					...
					<th class="tg-k27y" colspan="2" rowspan="2">PERMOHONAN PEMBUATAN PV / RV<br>(PAYMENT VOCHER / RECEIVE VOUCHER)</th>
			...
			<tbody>
				<tr>
					...
					<td class="tg-z9od" width="33%"> : FORM 008/PROS-MS-MLK3-002</td>
	...
	<div>
		<table class="tg" width="100%" style="border-color: black;">
			...
			<tbody>
                ...
                <tr>
					<td class="tg-5r9a" style="text-align:right" colspan="5">PPN No (..........) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 10%</td>
					<td class="tg-5r9a" style="text-align:center">...</td>
					<td class="tg-5r9a" style="text-align:center">...</td>
				</tr>
                <tr>
					<td class="tg-5r9a" style="text-align:right" colspan="5">PPH No (..........) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
					<td class="tg-5r9a" style="text-align:center">...</td>
					<td class="tg-5r9a" style="text-align:center">...</td>
				</tr>
                <tr>
