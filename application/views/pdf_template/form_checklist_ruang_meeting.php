...
<head>
    ...
    <title>FORM CHECKLIST RUANG MEETING</title>
...
<body>
    <div class="wrapper-page">
        ...
        <p class="text-align-center">
            <strong>RUANG MEETING INSPECTION CARD</strong>
        </p>
        ...
        <table class="border-1 border-collapse valign-middle text-align-center w-100 table-layout-fixed mb-min">
            <tr>
                <td class="border-1 p-min">Date</td>
                <td class="border-1 p-min">Time</td>
                <td class="border-1 p-min"><img src="<?= base_url('assets/img/form_meeting_assets/viewer.jpeg') ?>" alt="Image" width="50" height="50"><br>Viewer</td>
                <td class="border-1 p-min"><img src="<?= base_url('assets/img/form_meeting_assets/whiteboard.jpg') ?>" alt="Image" width="50" height="50"><br>White Board<br></td>
                <td class="border-1 p-min"><img src="<?= base_url('assets/img/form_meeting_assets/lcd.jpeg') ?>" alt="Image" width="50" height="50"><br>LCD</td>
                <td class="border-1 p-min"><img src="<?= base_url('assets/img/form_meeting_assets/screen.jpg') ?>" alt="Image" width="50" height="50"><br>Screen<br></td>
                <td class="border-1 p-min"><img src="<?= base_url('assets/img/form_meeting_assets/spidol.jpeg') ?>" alt="Image" width="50" height="50"><br>Spidol<br></td>
