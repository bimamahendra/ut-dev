    ...
    <div class="wrapper-page">
        ...
        <table class="border-2 border-collapse w-100 valign-middle mb-min">
            <tr>
                ...
                <td class="text-align-center border-1" colspan="2"><strong>FORM CHECKLIST RUANG MEETING</strong></td>
        ...
        <table class="border-1 border-collapse valign-middle text-align-center w-100 table-layout-fixed mb-min">
            <tr>
                ...
                <td class="border-1 p-min"><img src="https://via.placeholder.com/50" alt="Image" width="50" height="50"><br>Viewer</td>
                <td class="border-1 p-min"><img src="https://via.placeholder.com/50" alt="Image" width="50" height="50"><br>White Board<br></td>
                <td class="border-1 p-min"><img src="https://via.placeholder.com/50" alt="Image" width="50" height="50"><br>LCD</td>
                <td class="border-1 p-min"><img src="https://via.placeholder.com/50" alt="Image" width="50" height="50"><br>Screen<br></td>
                <td class="border-1 p-min"><img src="https://via.placeholder.com/50" alt="Image" width="50" height="50"><br>Spidol<br></td>
