...
<head>
	...
	<title>FORM PERMINTAAN MOBIL PRIBADI</title>
	<style>
		.watermark::before {
			position: absolute;
			top: 35%;
...
<body style="padding-left:0.5cm; font-family:Arial, sans-serif;">
	<div class="wrapper-page">
			...
			<table class="tg" width="100%;">
				<thead>
					<tr>
						...
						<th class="tg-k27y" colspan="2" rowspan="2">FORM PERMINTAAN MOBIL PRIBADI</th>
				...
				<tbody>
					<tr>
						...
						<td class="tg-z9od" width="33%"> : FORM 001/PROS-MFP-MLK3-013</td>
		...
		<div style="text-align:center">
			<h4>SURAT IZIN PEMINJAMAN KENDARAAN UNTUK KEPERLUAN PRIBADI</h4>
		</div>
		<div>
			<table class="tp">
				<tr>
		...
		<div>
			...
			<ol style="font-weight: bold;">
				<li>
					SEBELUM KENDARAAN DIBAWA KELUAR PERLENGKAPAN DAN KENDARAAN HARUS DIPERIKSA TERLEBIH
					DAHULU.
				</li>
				<li>
					KENDARAAN YANG DIKEMBALIKAN KE POOL HARUS KEADAAN BERSIH DAN LENGKAP.
				</li>
				<li>
					KERUSAKAN DAN KEHILANGAN KENDARAAN SERTA PERLENGKAPANNYA MENJADI TANGGUNG JAWAB
					PRIBADI (RESIKO SENDIRI).
				</li>
			</ol>
	...
	<div class="wrapper-page">
		<!-- Attach SIM disini -->
		<img src="<?= $list[0]->ATTACHMENT_MOBPRI?>" style="max-width: 400px; display: block; margin-left: auto; margin-right: auto;" alt="">
	</div>
</body>
