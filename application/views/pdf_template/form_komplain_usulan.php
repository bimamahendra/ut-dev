...
<head>
	...
	<title>FORM KOMPLAIN / USULAN</title>
	<style>
		.tg {
			border-style: solid;
			border-width: 2px;
...
<body style="padding-left:0.5cm; font-family:Arial, sans-serif;">
	...
	<div>
		<table style="width:80%; text-align:left; font-size:12px;">
			<tr>
				...
				<td>
					<?php
					$date 		= date_create($list[0]->TGLOUT_KOMPLAIN);
		...
		<table class="tg" width="100%" style="border-color: black;">
			<thead>
				<tr>
					...
					<th class="tg-5rbv">Nama</th>
					<th class="tg-5rbv">Divisi</th>
					<th class="tg-5rbv">Komplain / Usulan</th>
				</tr>
			</thead>
			<tbody>
				<?php
				...
				foreach ($list as $item) {
					echo '
								<tr>
									<td class="tg-5r9a">' . $no . '</td>
									<td class="tg-5r9a">' . $item->NAMA_KOMPLAIN . '</td>
									<td class="tg-5r9a">' . $item->DIV_KOMPLAIN . '</td>
									<td class="tg-5r9a">' . $item->KOMPLAIN_USULAN . '</td>
								</tr>
							';
					$no++;
				}
	...
	<br>
	<div>
		<table class="thd" style="width: 400px; table-layout: fixed;" align="right">
			<tr>
				<td class="thd-tha" width="50%">Diketahui Oleh : </td>
				<td class="thd-tha" width="50%">Disetujui Oleh : </td>
			</tr>
			<tr>
				<td class="thd-td2">
