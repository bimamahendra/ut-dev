		...
		<table class="tg" width="100%;">
			<thead>
				<tr>
					...
					<th class="tg-k27y" colspan="2" rowspan="2">FORM KOMPLAIN / USULAN</th>
			...
			<tbody>
				<tr>
					...
					<td class="tg-z9od" width="33%"> : FORM 005/PROS-MFP-MLK3-013 </td>
	...
	<div>
		<table class="tg" width="100%" style="border-color: black;">
			...
			<tbody>
                ...
                <tr>
					<td class="tg-5r9a">7.</td>
					<td class="tg-5r9a">...</td>
					<td class="tg-5r9a">...</td>
					<td class="tg-5r9a">...</td>
				</tr>
                <tr>
					<td class="tg-5r9a">8.</td>
					<td class="tg-5r9a">...</td>
					<td class="tg-5r9a">...</td>
					<td class="tg-5r9a">...</td>
				</tr>
                <tr>
					<td class="tg-5r9a">9.</td>
					<td class="tg-5r9a">...</td>
					<td class="tg-5r9a">...</td>
					<td class="tg-5r9a">...</td>
				</tr>
                <tr>
					<td class="tg-5r9a">10.</td>
					<td class="tg-5r9a">...</td>
					<td class="tg-5r9a">...</td>
					<td class="tg-5r9a">...</td>
				</tr>
