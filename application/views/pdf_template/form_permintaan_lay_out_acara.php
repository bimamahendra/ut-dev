...
<body style="padding-left:0.5cm; font-family:Arial, sans-serif;">
	...
	<div style="text-align:center">
		<h5>FORM PERMINTAAN LAY OUT ACARA</h5>
	</div>
	<div>
		<table class="tg" width="100%" style="border-color: black;">
			<thead>
				...
				<tr>
					...
					<td class="tg-5rbv" style="text-align:left">
						Beban biaya : <?= $list[0]->BIAYA_LAYOUT ?></td>
				</tr>
				<tr>
	...
	<div>
		<table class="thd" style="table-layout: fixed;">
			<tr>
				<td width="25%" class="thd-tha">Pemohon : </td>
				<td width="25%" class="thd-tha">Diketahui Oleh : </td>
				<td width="25%" class="thd-tha">Diketahui Oleh : </td>
				<td width="25%" class="thd-tha">Disetujui Oleh : </td>
			</tr>
