...
<head>
	...
	<title>FORM MATERIAL USED SLIP</title>
	<style>
		.watermark::before {
			position: absolute;
			top: 35%;
...
<body style="padding-left:0.5cm; padding-right:0.5cm; font-family:Arial, sans-serif;">
		...
		<table class="tg" width="100%;">
			<thead>
				<tr>
					...
					<th class="tg-k27y" colspan="2" rowspan="2">FORM MATERIAL USED SLIP</th>
			...
			<tbody>
				<tr>
					...
					<td class="tg-z9od" width="33%"> : FORM 016/PROS-MFP-MLK3-014</td>
	...
	<div>
		<table class="thd" align="right">
			...
			<tr>
				<td class="thd-tha"><b>PIC Gudang</b></td>
	...
	<div style="text-align:center">
		<h5 style="padding-top: 2px; padding-bottom: 2px;">MATERIAL USED SLIP</h5>
	</div>
    <div>
		<table style="width:80%; text-align:left; font-size: 8px;">
			<tr>
