    ...
    <div class="wrapper-page">
        ...
        <table class="border-2 border-collapse w-100 valign-middle mb-min">
            ...
            <tr>
                ...
                <td class="text-regular-sm border-right pt-min" style="width: 30%;">: FORM 009/PROS-MFP-MLK3-014</td>
        ...
        <table class="w-100 border-collapse border-1 mb-min">
            <tr>
                <th class="border-1 p-min">No</th>
                <th class="border-1 p-min">LAPORAN PERBAIKAN</th>
                <th class="border-1 p-min">Kategori</th>
                <th class="border-1 p-min">Lokasi</th>
                <th class="border-1 p-min">User</th>
                <th class="border-1 p-min">PIC</th>
            ...
            foreach ($list as $item) {
                ...
                echo '
                     <tr>
                          ...
                          <td class="border-1 p-min">' . $item->DURASI_PERBAIKAN . ' Jam</td>
