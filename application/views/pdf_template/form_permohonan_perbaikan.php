...
<body style="padding-left:0.5cm; font-family:Arial, sans-serif;">
		...
		<table class="tg" width="100%;">
			<thead>
				<tr>
					...
					<th class="tg-k27y" colspan="2" rowspan="2">FORM PERMOHONAN PERBAIKAN</th>
	...
	<div>
		<table class="thd">
			<thead>
				<tr>
					<th class="thd-baqh" colspan="2" style="border-bottom: none;">Status Pekerjaan</th>
			...
			<tbody>
				<tr>
					...
					<td rowspan="2">
						...
						<label for="checkbox_status2">Pending</label>
					</td>
					<td class="thd-baqh">Puas</td>
					<td class="thd-baqh">Cukup</td>
					<td class="thd-baqh">Tidak Puas</td>
				</tr>
				<tr>
