...
<html lang="en">
    <head>
        ...
        <style>			
			...
			.tg .tg-xsvg{font-size:12px;font-weight:bold;text-align:justify;padding-left:23px;border-color:black;border-style:solid;border-width:2px;}
    ...
    <body style="padding-left:1cm; font-family:Arial, sans-serif; font-size:15px">
		<div>
			<table class="tg" width="100%;">
				<thead>
					<tr>
						...
						UNITED TRACTORS</th>
						<th class="tg-k27y" colspan="2" rowspan="2">FORM PEMBELIAN SNACK</th>
						<th class="tg-k27y" rowspan="2">INTEGRASI SISTEM</th>
					</tr>
					<tr>
						<td class="tg-w2dt" rowspan="4">Jl. Raya Bekasi Km. 22 Cakung<br>Jakarta</td>
					</tr>
				</thead>
				<tbody>
					<tr>
		...
		<br />
		<div>
			<p>Snack yang diminta sebagai berikut :</p>
		</div>
		<div>
			<table style="width:100%;">	
				<tr>
					<td style="width: 5%"></td>
					<td style="text-align:center;">Jenis Snack</td>
