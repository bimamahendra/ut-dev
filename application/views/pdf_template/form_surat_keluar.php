...
<body style="padding-left:0.5cm; font-family:Arial, sans-serif;">
    ...
    <div>
		<table style="width:80%; text-align:left; font-size: 12px; padding-left: 32px; padding-top: 1px; padding-right:1px;">
			<tr>
				<td style="width: 20%;"><h4>PT UNITED TRACTORS Tbk</h4></td>
			</tr>
			<tr>
				<td>Jalan Raya Bekasi Km. 22 Cakung, Jakarta 13910 - Indonesia</td>
			</tr>
            <tr>
				<td>Tel   : (62-21) 2457 9999</td>
			</tr>
            <tr>
				<td>Fax   : (62-21) 460 0657  460 0677</td>
			</tr>
            <tr>
				<td>www.unitedtractors.com</td>
			</tr>
		</table>
	</div>
    <br>
    ...
    <div>
		<table style="width:95%; text-align:left; font-size: 12px; padding-top: 1px; padding-right:1px;">
            ...
            <tr>
				<td><u>P.P.I Cakung - Jakarta Timur</u></td>
                <td></td>
                <td></td>
			</tr>
		</table>
    ...
    <br>
	<div>
		<table style="width:95%; text-align:left; font-size: 14px; padding-top: 1px; padding-right:1px;">
			<tr>
				<td style="width: 60%;">Harap Diberikan Izin Kepada Pemegang Surat Jalan Ini :  </td>
			</tr>
		</table>
	</div>
    <br>
