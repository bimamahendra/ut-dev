...
<body style="padding-left:0.5cm; font-family:Arial, sans-serif;">
		...
		<table class="tg" width="100%;">
			<thead>
				<tr>
					...
					<th class="tg-k27y" colspan="2" rowspan="2">FORM HASIL TEST FOOD CATERING</th>
	...
	<div>
		<table class="tg" width="100%" style="border-color: black;">
			...
			<tbody>
				<tr>
					<td class="tg-5r9a" rowspan="7" style="width=3%; text-align:center;">1.</td>
					<td class="tg-5r9a" rowspan="7">...</td>
				...
				<tr>
					<td class="tg-5r9a" rowspan="7" style="width=3%; text-align:center;">2.</td>
					<td class="tg-5r9a" rowspan="7">...</td>
					<td class="tg-5r9a">Rasa</td>
					<td class="tg-5r9a">...</td>
					<td class="tg-5r9a">...</td>
				...
				<tr>
					<td class="tg-5r9a" rowspan="7" style="width=3%; text-align:center;">3.</td>
					<td class="tg-5r9a" rowspan="7">...</td>
					<td class="tg-5r9a">Rasa</td>
					<td class="tg-5r9a">...</td>
					<td class="tg-5r9a">...</td>
				...
				<tr>
					<td class="tg-5r9a" rowspan="7" style="width=3%; text-align:center;">4.</td>
					<td class="tg-5r9a" rowspan="7">...</td>
					<td class="tg-5r9a">Rasa</td>
					<td class="tg-5r9a">...</td>
					<td class="tg-5r9a">...</td>
